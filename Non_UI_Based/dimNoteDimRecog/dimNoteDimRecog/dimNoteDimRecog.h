...
namespace dimNoteDimRecog
{
	...
	const double dimGDTNoteSet_WIDTH_PADDING_FACTOR = 1.3;
	const double dimGDTNoteSet_HEIGHT_PADDING_FACTOR = 1.5;
	...
	class opVector {
	public:
		std::vector<DimSet> vectorOfdimGDTNoteSet1;
		std::vector<DimSet> vectorOfdimGDTNoteSet2;
		std::vector<DimSet> vectorOfdimGDTNoteSet3;
		std::vector<DimSet> vectorOfdimGDTNoteSet4;
	};
	///////////////////////////////////////////////////////////////////////////////////////////////////
	class Character {
	public:
